...
.controller('RecordCtrl', ['$scope', '$http', '$routeParams', '$timeout', 'WikidataService', function($scope, $http, $routeParams, $timeout, WikidataService) {
  ...
  const roles = {
    ...
    'aui': {label: 'Author of introduction, etc.', adverb: 'in'},
    ...
    'ctb': {label: 'Contributor', adverb: 'to'},
    ...
    'dub': {label: 'Dubious author', adverb: 'of'},
    'edc': {label: 'Editor of compilation', adverb: ':'},
    'edm': {label: 'Editor of moving image work', adverb: ':'},
    'edt': {label: 'Editor', adverb: 'of'},
    ...
    'trl': {label: 'Translator', adverb: 'of'},
